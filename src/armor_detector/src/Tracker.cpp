...
void nw::Tracker::initTracker(const Mat &input_image, Point2i top_left, Point2i bottom_right){
...
void nw::Tracker::initTracker(const Mat &input_image, Rect input_rect) {
...
void nw::Tracker::calcDFT(Image &input_image, bool preprocess) {
...
Mat nw::Tracker::calcDFT(const Mat &input_image, bool preprocess) {
...
void nw::Tracker::setRoi(const Rect& input_roi) {
...
void nw::Tracker::maskDesiredG(Mat &output, int u_x, int u_y, double sigma, bool norm_energy) {
...
Mat nw::Tracker::createEps(const Mat &input_, double std) {
...
void nw::Tracker::AffineTransform(const Mat &input_image, const Mat &input_image2, Mat &aff_img, Mat &aff_img2)
...
void nw::Tracker::dftDiv(const Mat &dft_a, const Mat &dft_b, Mat &output_dft)
...
void nw::Tracker::track(const Mat &frame) {
...
float nw::Tracker::calcPSR(const Mat &correlation_mat) {
...
void nw::Tracker::update(Point2i new_location) {
...
void nw::Tracker::updateRoi(Point2i new_center, bool scale_rot) {
